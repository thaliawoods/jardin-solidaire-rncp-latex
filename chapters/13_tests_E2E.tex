...
En complément des tests unitaires et d’intégration, j’ai mis en place des tests \textbf{end-to-end (E2E)} avec \textbf{Playwright}. Mon objectif est de vérifier que Jardin Solidaire fonctionne \textbf{comme un.e utilisateur.ice le vit}, à l’écran, et pas seulement en théorie via une fonction ou une réponse JSON.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.67\textwidth]{assets/13_tests_E2E/code_e2e_gardens_spec.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.55\textwidth]{assets/13_tests_E2E/code_e2e_register_spec1.png}\par\smallskip
  \includegraphics[width=0.55\textwidth]{assets/13_tests_E2E/code_e2e_register_spec2.png}
