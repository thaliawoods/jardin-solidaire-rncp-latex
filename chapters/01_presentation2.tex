\chapter{Présentation du projet (EN)}
...
In this context, I developed \textbf{Jardin Solidaire}.
...
\textbf{Jardin Solidaire} is a mutual-aid web platform that connects \textbf{garden owners} with \textbf{volunteer gardeners}. The goal is not to build a commercial service: there is no payment. It focuses on shared time, cooperation, and knowledge transmission, bringing sleeping gardens back to life and enabling local connections.
...
Jardin Solidaire sits at the intersection of \textbf{tech}, \textbf{social impact}, and \textbf{ecology}: a simple way to build connections, share skills, and take care of neighborhood green spaces.
