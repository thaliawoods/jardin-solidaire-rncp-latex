...
Avant d’écrire les tests, j’ai listé les \textbf{parcours critiques} (ceux qui bloquent l’usage si ça casse) et j’ai associé à chacun un type de test, un outil et un critère de succès. Ce choix me permet de tester en priorité ce qui a le plus d’impact utilisateur, de rendre la stratégie lisible et ne pas tester pas au hasard.
