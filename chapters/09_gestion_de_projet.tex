...
\begin{figure}[H]
  ...
  \caption{Workflow : du ticket à l’intégration}
...
Pour éviter des tickets terminés mais incomplets, j’ai mis en place une \textbf{Definition of Done} simple :
\begin{itemize}
