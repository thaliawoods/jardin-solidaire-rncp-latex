...
\begin{itemize}
  ...
  \item les \textbf{clés étrangères}, c’est-à-dire des champs qui pointent vers une autre table pour créer un lien. Par exemple, une réservation contient l’identifiant de l’utilisateur.ice et l’identifiant du jardin (et/ou du créneau) pour savoir qui a réservé quoi ;
...
J’ai choisi \textbf{PostgreSQL} parce que Jardin Solidaire manipule des données \textbf{structurées} et \textbf{fortement liées} : utilisateur.ices, jardins, créneaux, réservations, messages, avis... Une base relationnelle me permet de modéliser ces liens proprement (clés étrangères, contraintes), et donc d’éviter des incohérences dès l’écriture en base.
