...
Pour construire Jardin Solidaire, j’ai choisi une stack web moderne, organisée \og en couches \fg{}. Une \textbf{architecture en couches} signifie que l’on sépare clairement les responsabilités.

La première couche est l’\textbf{interface}, c’est-à-dire tout ce que l’utilisateur.ice voit et manipule dans son navigateur : les pages, les formulaires, les boutons, les listes, la carte, etc.
