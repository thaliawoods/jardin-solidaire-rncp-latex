...
Avant de construire l’application, j’ai cadré le projet pour vérifier qu’il répondait à des attentes réelles. Pour cela, j’ai commencé par un \textbf{questionnaire} envoyé autour de moi pour identifier la cible, mais aussi pour comprendre les freins et les attentes des futur.es utilisateur.ices.
