...
Envoi d’une demande sur un créneau libre. Suivi d’un statut clair : \textit{en attente}, \textit{acceptée}, \textit{refusée}, \textit{planifiée}, \textit{réalisée} ou \textit{annulée}. Le propriétaire peut accepter ou refuser, et le.la jardinier.e peut annuler avant la réalisation.
